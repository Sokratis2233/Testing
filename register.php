...
<head>
  <title>Silent Location Bot Registration page</title>
  ...
  <form method="post" action="register.php">
	  ...
	  <label for="country">Country</label><span style="color: red !important; display: inline; float: none;">*</span>      
            ...
            <select id="country" name="country" class="form-control" value=<?php echo $country; ?>>
        	  ...
        	  <label for="gender">Select your Gender</label><span style="color: red !important; display: inline; float: none;">*</span>      
